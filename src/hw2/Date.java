...
class Date {
    ...
    public int difference(Date d) {
        ...
        if (small.year < large.year) {
            for (int i = small.year + 1; i <= large.year - 1; i++) {
                res += (isLeapYear(i) ? 366 : 365);
            }
            res += (isLeapYear(small.year) ? 366 : 365 - small.dayInYear());
            res += large.dayInYear();
        } else {
            res += (large.dayInYear() - small.dayInYear());
        }
    ...
    public static void main(String[] argv) {
        ...
        System.out.println(d5 + " - " + d4  + " should be 48762: " +
                d5.difference(d4));
        System.out.println(d6 + " - " + d4  + " should be 32: " +
                d6.difference(d4));
    }
}
